<header class="main-header">
	<nav class="navbar navbar-static-top">
		<div class="navbar-header">
			<a href="<?= site_url() ?>" class="navbar-brand"><b>
                    <i class="in-con fa fa-unlock-alt"    >  </i> E-Lock</b> Server</a>
					...
					<ul class="dropdown-menu">
						...
						<!-- 	<div class="pull-left">
							...
							<div class="pull-right">
								<a href="<?= site_url('Log_Out') ?>" class="btn btn-default btn-flat">Logout</a>
							</div>
						</li>
					</ul>
				</li>
